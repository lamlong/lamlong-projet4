...
public class DBConstants {
    ...
    public static final String TICKETS_BY_IMMAT = "select count(*) from ticket t,parking p where p.parking_number = t.parking_number and t.VEHICLE_REG_NUMBER=?"; // Jordi : A regarder quand le cours est fait.
}
