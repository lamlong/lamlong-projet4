...
public class FareCalculatorServiceTest {
    ...
    public void calculateFareCarWithLessThan30Minutes() {
    	// Calculer le prix d'un ticket de voiture qui stationne moins de 30 min.
    	
    	// Créer notre ticket de moins de 30 min.
        ...
        // On créé notre place de parking.
        ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.CAR,false);
        
        // On affecte les différentes valeurs à notre ticket.
        ticket.setInTime(inTime);
        ticket.setOutTime(outTime);
        ticket.setParkingSpot(parkingSpot);
        
        // On calcule le prix du ticket.
        fareCalculatorService.calculateFare(ticket);
        
        // On fait notre test du prix du ticket.
        assertEquals(ticket.getPrice(), 0); 
    }
    
    @Test
    public void calculateFareBikeWithLessThan30Minutes() {
    	// Calculer le prix d'un ticket de vélo qui stationne moins de 30 min.
